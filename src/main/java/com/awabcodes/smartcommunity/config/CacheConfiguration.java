package com.awabcodes.smartcommunity.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.awabcodes.smartcommunity.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.awabcodes.smartcommunity.repository.UserRepository.USERS_BY_EMAIL_CACHE);
