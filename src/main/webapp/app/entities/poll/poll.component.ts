...
export class PollComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pollService
      ...
      .subscribe(
        (res: HttpResponse<IPoll[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IPoll): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInPolls(): void {
  ...
  protected onSuccess(data: IPoll[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
