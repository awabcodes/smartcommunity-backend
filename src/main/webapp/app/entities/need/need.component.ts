...
export class NeedComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.needService
      ...
      .subscribe(
        (res: HttpResponse<INeed[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInNeeds(): void {
    this.eventSubscriber = this.eventManager.subscribe('needListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: INeed[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
